...
const messageSchema = new mongoose.Schema({
    ...
    systemType: {
        ...
        enum: ['member_added', 'member_kicked', 'member_left', 'group_disbanded',
            ...
            'admin_transferred', 'reminder_created_local', 'shared_reminder_created', 'shared_reminder_participation_changed', 'shared_reminder_cancelled', 'shared_reminder_updated'],
    },
    metadata: {
        type: Map,
