                        ...
                        <div className="space-y-1.5">
                            {friends.map((friend) => {
                                ...
                                return (
                                    <div
                                        key={friend._id}
                                        className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-card border border-border/40 hover:border-primary/20 hover:shadow-soft transition-all duration-200"
                                    >
                ...
                {friends.length === 0 && (
                    <div className="flex-1 h-full flex flex-col items-center justify-center py-20 px-6">
                        ...
                        <p className="text-sm text-muted-foreground/50 text-center max-w-xs">
                            Tìm kiếm và gửi lời mời kết bạn để bắt đầu kết nối.
                        </p>
                    </div>
                )}
            </div>
