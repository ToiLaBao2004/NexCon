              ...
              <div className="absolute right-4 top-[7px] z-20 flex items-center gap-2">
                {isHost && waitingRoom.length > 0 ? (
                  <button
                    ...
                    className="inline-flex h-9 items-center gap-2 rounded-full border border-primary/40 bg-primary px-4 text-sm font-semibold text-white shadow-lg transition-colors hover:bg-primary/90"
                  >
                  ...
                  <button
                    onClick={() => setIsSidebarOpen((prev) => !prev)}
                    className="inline-flex h-9 items-center gap-2 rounded-full border border-border bg-card/95 px-3.5 text-sm font-semibold text-foreground shadow-lg transition-colors hover:bg-muted dark:border-slate-600 dark:bg-slate-800/95 dark:text-slate-100 dark:hover:bg-slate-700"
                  >
                    <Users size={16} />
                    {participants.length}
                  </button>
