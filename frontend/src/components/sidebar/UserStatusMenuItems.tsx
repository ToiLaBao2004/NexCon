...
const MANUAL_STATUS_OPTIONS: {
  ...
  { status: "online", label: "Online", dotClass: "bg-emerald-500" },
  { status: "away", label: "Away", dotClass: "bg-amber-400" },
  { status: "busy", label: "Busy", dotClass: "bg-red-500" },
  { status: "do_not_disturb", label: "Do Not Disturb", dotClass: "bg-red-600" },
  { status: "invisible", label: "Invisible", dotClass: "bg-zinc-400" },
];
    ...
    <>
      ...
      {!showActivity && (
        <div className="px-3 pb-2 text-xs leading-snug text-muted-foreground">
          Bạn vẫn nhận tin nhắn và cuộc gọi realtime; người khác chỉ thấy bạn offline.
        </div>
      )}
    </>
  );
